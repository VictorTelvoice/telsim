    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-[#111318] dark:text-white antialiased min-h-screen flex flex-col items-center">
        <div className="relative flex h-full min-h-screen w-full max-w-md flex-col bg-background-light dark:bg-background-dark overflow-x-hidden shadow-2xl pb-40">
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 overflow-y-auto no-scrollbar">
                ...
                {/* PLAN CARD */}
                <div className="bg-white dark:bg-[#1A2230] rounded-[2.5rem] border border-slate-100 dark:border-slate-800 p-6 shadow-soft mb-6 flex justify-between items-center group transition-all hover:border-primary/20">
                ...
                {/* ONE-CLICK OPTION (SI EXISTE) */}
                {paymentInfo && !isProcessing && (
                  <div className="p-6 bg-emerald-50 dark:bg-emerald-500/5 rounded-[2rem] border border-emerald-100 dark:border-emerald-500/20 flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-2 duration-700">
                    <div className="flex items-center gap-4">
                        <div className="size-10 rounded-xl bg-white dark:bg-slate-800 flex items-center justify-center shadow-sm text-emerald-500">
                           <Zap className="size-5" />
                        </div>
                        <div>
                           <p className="text-[10px] font-black text-emerald-700 dark:text-emerald-400 uppercase tracking-widest leading-none mb-1">Pago Instantáneo Activo</p>
                           <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400">Pagarás con tu {paymentInfo.brand} •• {paymentInfo.last4}</p>
                        </div>
                    </div>
                    <button 
                    ...
                    >
                        ...
                        <span className="text-[13px] uppercase tracking-widest">Pagar Ahora</span>
                ...
                <div className="mt-8 p-5 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-800 flex gap-4">
                    ...
                    <p className="text-[10px] font-bold text-slate-600 dark:text-slate-400 leading-relaxed italic">
                        Confirmación: No se realizará ningún cargo hasta que finalice el periodo de prueba de 7 días. Puedes cancelar en cualquier momento desde el panel.
                    </p>
                </div>
            </div>
