      ...
      <div className="w-full max-w-sm mx-auto relative z-10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-6 transform -rotate-2 relative">
            ...
            <div className="relative z-10">
              <TelsimBrandLogo className="flex-col gap-4" iconClassName="h-[104px] w-[104px] rounded-[1.85rem] drop-shadow-2xl" textClassName="text-[2.45rem]" />
            </div>
          </div>
        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">O regístrate con</span>
            <div className="h-px bg-slate-100 dark:bg-slate-800 flex-1"></div>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-300">Registrarse con Google</span>
          </button>
        </div>
        ...
        <p className="mt-8 text-[10px] text-center text-slate-400 dark:text-slate-500 font-bold px-4">
