...
/**
 * Sistema de tickets: lista de tickets de usuarios y navegación al chat para responder.
 * Al enviar una respuesta desde el chat (AdminTicketChat), el cliente recibe notificación por Telegram si tiene bot configurado.
 */
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="text-sm text-slate-400 mb-6">
        Lista de tickets de usuarios. Entra a uno para abrir el chat y responder.
      </p>
