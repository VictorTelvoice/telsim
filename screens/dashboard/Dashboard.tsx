...
const Dashboard: React.FC = () => {
  ...
  const getPlanStyle = (plan: string | undefined | null) => {
    ...
    if (p.includes('PRO')) {
      return {
        card: 'border-blue-100 dark:border-blue-800 shadow-soft',
    ...
    return {
      card: 'border-slate-100 dark:border-slate-800 shadow-soft',
              ...
              {allSlots?.map((slot) => {
                ...
                return (
                  <div 
                    ...
                    className={`bg-white dark:bg-surface-dark rounded-3xl p-6 border transition-all cursor-pointer group relative overflow-hidden ${style.card} hover:scale-[1.01]`}
                  >
                      {/* Badge de Plan Superior */}
                          ...
                          <div className="flex items-center gap-3">
                              ...
                              <div>
                                  ...
                                  <div className="flex items-center gap-2">
                                      <span className={`text-[9px] font-black uppercase tracking-widest ${style.text}`}>Red Activa</span>
                                      <div className="size-1 bg-emerald-500 rounded-full animate-pulse"></div>
                                  </div>
                              </div>
                          </div>
                          <div className="size-10 bg-slate-50 dark:bg-slate-800 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-primary group-hover:text-white transition-colors mt-2">
