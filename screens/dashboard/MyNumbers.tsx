    ...
    const handleSaveLabel = async (slotId: string) => {
        ...
        try {
            const { error } = await supabase
                ...
                .eq('slot_id', slotId); // Corregido a slot_id
    ...
    const handleReleaseSlot = async () => {
        ...
        try {
            const { error } = await supabase
                ...
                .eq('slot_id', slotToRelease.slot_id); // Corregido a slot_id para solucionar error 42703
    ...
    const handleSaveAutomation = async () => {
        ...
        try {
            ...
            const { error: slotError } = await supabase
                ...
                .eq('slot_id', activeConfigSlot.slot_id); // Corregido a slot_id
