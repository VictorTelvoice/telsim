...
const MyNumbers: React.FC = () => {
    ...
    const handleSaveAutomation = async () => {
        ...
        try {
            ...
            showToast("Configuración de API Guardada");
    ...
    const handleTestWebhook = async () => {
        ...
        try {
            const testPayload = {
                sender: "TELSIM_BOT",
                content: "Hola desde TELSIM! Este es un mensaje de prueba para validar tu integración.",
            ...
            const response = await fetch(userWebhookUrl, {
                ...
                mode: 'no-cors' // Para evitar problemas de CORS en pruebas rápidas
            });

            showToast("Test enviado correctamente");
        } catch (err) {
            console.error("Webhook test failed:", err);
            showToast("Fallo al conectar con el endpoint", "error");
        } finally {
    ...
    return (
        <div className="min-h-screen relative bg-[#F8FAFC] dark:bg-background-dark font-display pb-32">
                    ...
                    <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 space-y-6 shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">URL de Webhook (Global)</label>
                                <div className="relative group">
                                    ...
                                    <input 
                                        ...
                                        placeholder="https://make.com/webhooks/..." 
                                ...
                                <p className="text-[9px] font-bold text-slate-400 px-1 leading-relaxed">
                                    Enviaremos un POST JSON cada vez que cualquier línea asignada reciba un SMS.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                >
                                    {savingFwd ? 'Guardando...' : 'Actualizar Integración'}
                                </button>
                            </div>
            ...
            {/* OTROS MODALES (RELEASE, PLANES)... Mantenidos por integridad */}
