...
export default async function handler(req, res) {
    ...
    const q = supabaseAdmin
        .from('finance_events')
        .select('id, stripe_event_id, stripe_event_type, finance_event_type, occurred_at, user_id, subscription_id, slot_id, plan_name, billing_type, currency, amount_cents, risk_amount_cents, metadata, created_at')
